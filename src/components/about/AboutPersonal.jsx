    ...
    <Container>
      ...
      <PageContent>
        <LeftPane>
          ...
          <p>
            I love travelling (...I mean who doesn't), am a photography enthusiast and into biking and occasionally nowhere to be found on weekends. I'm also
            part of a professional rider's groups. So, I'm always in for both solo trips and group rides.
          </p>
        </LeftPane>
        <RightPane></RightPane>
      </PageContent>
